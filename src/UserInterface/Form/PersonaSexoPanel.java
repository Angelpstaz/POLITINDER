...
public class PersonaSexoPanel extends JPanel {
    ...
    private void createPersonaSexo() {
        ...
        String nombre = JOptionPane.showInputDialog(this, "Ingrese el nombre del nuevo tipo de persona sexo:", "Crear Tipo de Persona Sexo", JOptionPane.QUESTION_MESSAGE);
        if (nombre != null && !nombre.isEmpty()) {
            try {
                ...
                nuevoTipoPersonaSexo.setNombre(nombre);
